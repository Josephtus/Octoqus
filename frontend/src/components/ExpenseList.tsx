  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
        <h3 className="text-lg sm:text-xl font-black text-slate-100 flex items-center gap-2 sm:gap-3">
      ...
      <div className="bg-slate-900/50 border border-slate-800/60 rounded-[1.5rem] sm:rounded-[2rem] p-3 sm:p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
        <div className="absolute -top-16 -left-16 sm:-top-24 sm:-left-24 w-48 h-48 sm:w-64 sm:h-64 bg-[#00f0ff]/5 rounded-full blur-[80px] sm:blur-[100px] pointer-events-none group-hover:bg-[#00f0ff]/10 transition-all duration-1000"></div>
        
        <div 
          ref={containerRef}
          id="expense-scroll-container"
          className="h-[400px] sm:h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent custom-scroll"
        >
      ...
      <AnimatePresence>
        {editingExpense && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
            <div className="bg-slate-900 border border-slate-800 p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] w-full max-w-md shadow-2xl relative max-h-[90vh] overflow-y-auto custom-scrollbar">
              <div className="absolute top-0 left-0 w-full h-1 bg-[#00f0ff]"></div>
              <h4 className="text-xl sm:text-2xl font-black text-[#00f0ff] mb-4 sm:mb-6 mt-2 sm:mt-0">Harcamayı Düzenle</h4>
              <form onSubmit={handleUpdate} className="space-y-4 sm:space-y-5">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button 
                    ...
                    className="flex-1 py-3 sm:py-4 bg-[#00f0ff] text-slate-950 rounded-2xl font-black text-xs sm:text-sm shadow-[0_0_20px_#00f0ff44] hover:bg-[#00c0cc] transition-all disabled:opacity-50"
                  >
