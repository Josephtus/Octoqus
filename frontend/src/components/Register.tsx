      ...
      >
        ...
        <div className="bg-slate-900/40 backdrop-blur-3xl border border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Şifre Tekrarı</label>
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-[#b026ff] transition-colors">
                  <Lock size={18} />
                </div>
                <input 
                  ...
                  className={`w-full pl-12 pr-12 py-4 rounded-2xl bg-slate-950/50 border transition-all ${
                    errors.confirm_password ? 'border-red-500/50 focus:border-red-500' : 'border-white/5 focus:border-[#b026ff]/50'
                  } text-white placeholder:text-slate-600 focus:outline-none focus:bg-slate-950`}
                  placeholder="Şifrenizi tekrar girin"
                />
              </div>
              {errors.confirm_password && <p className="text-[10px] text-red-400 ml-1 font-bold">{errors.confirm_password.message}</p>}
            </div>
