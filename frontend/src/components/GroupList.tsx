...
export const GroupList: React.FC<GroupListProps> = ({ onSelectGroup }) => {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-20">
      {/* Header & Join Section */}
      <div className="bg-slate-900/40 backdrop-blur-3xl border border-white/5 p-4 sm:p-8 rounded-[24px] sm:rounded-[32px] shadow-2xl flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#00f0ff]/5 blur-3xl rounded-full pointer-events-none" />
        
        <div className="relative z-10">
          <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">Gruplarım</h2>
        ...
        <form onSubmit={handleJoinByCode} className="relative w-full max-w-lg flex flex-col sm:flex-row gap-2 sm:gap-3 z-10">
          ...
          <button 
            ...
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-black rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-[#00f0ff] transition-all active:scale-95 disabled:opacity-50 disabled:grayscale shadow-xl flex items-center justify-center gap-2 whitespace-nowrap"
          >
              ...
              {currentGroups.map((group, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group bg-slate-900/60 backdrop-blur-md border border-white/5 rounded-[24px] sm:rounded-[40px] p-5 sm:p-8 hover:border-[#00f0ff]/30 transition-all cursor-pointer shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[280px] sm:min-h-[320px]"
                  >
