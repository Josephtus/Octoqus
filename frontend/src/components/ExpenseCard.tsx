...
export const ExpenseCard: React.FC<ExpenseCardProps> = ({ 
  ...
  return (
    <motion.div 
      ...
      className="group relative flex items-start sm:items-center gap-3 sm:gap-4 p-3 bg-slate-900/40 border border-slate-800/60 rounded-2xl hover:bg-slate-800/60 hover:border-[#00f0ff]/30 transition-all cursor-pointer"
    >
      {/* Sol Kısım: İkon ve Miktar */}
      <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-slate-950 rounded-xl flex items-center justify-center border border-slate-800 group-hover:border-[#00f0ff]/20 transition-colors text-lg sm:text-xl">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 text-[9px] sm:text-[10px] font-bold text-slate-500">
